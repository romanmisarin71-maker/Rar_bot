...
def get_chat_members(chat_id: int):
    ...
    conn.close()
    return rows
answers_rar = ["Дисс на Хинечку!!! Ты конченое уебище и полное ничтожество! Мой создатель скажешь ты? Боже, лучше бы я сама писала свои коды в питоне! РАУНД!!!", "Что такое?", "Звали?", "Я не сплю... Честно!!!"]
last_reply = None
